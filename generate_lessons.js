...
const curriculumData = [
  ...
  // 2. Everyday words
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentences: { en: 'I drink water.', es: 'Bebo agua.', fr: "Je bois de l'eau.", de: 'Ich trinke Wasser.', it: 'Bevo acqua.', ar: 'أنا أشرب الماء.', ko: '저는 물을 마십니다.', ja: '私は水を悩みます。' }
      },
      {
        picture: '🍎',
        translations: { en: 'Apple', es: 'Manzana', fr: 'Pomme', de: 'Apfel', it: 'Mela', ar: 'تفاحة', ko: '사과', ja: 'りん고' },
    ...
    words: [
      {
        ...
        exampleSentences: { en: 'I like rice.', es: 'Me gusta el arroz.', fr: 'J\'aime le riz.', de: 'Ich mag Reis.', it: 'Mi piace il riso.', ar: 'أنا أحب الأرز.', ko: '저는 밥을 좋아합니다.', ja: '저는 밥을 좋아합니다.' }
      },
      {
        picture: '🍞',
        translations: { en: 'Bread', es: 'Pan', fr: 'Pain', de: 'Brot', it: 'Pane', ar: 'خبز', ko: '빵', ja: 'パン' },
        pronunciations: { en: 'Bread', es: 'pan', fr: 'pan', de: 'brot', it: '阻-neh', ar: 'khubz', ko: 'ppang', ja: 'pan' },
  ...
  // 5. Family
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentences: { en: 'My father is tall.', es: 'Mi padre es alto.', fr: 'Mon père est grand.', de: 'Mein Vater ist groß.', it: 'Mio padre è alto.', ar: 'أبي طويل القامة.', ko: '저의 아버지는 키가 크십니다.', ja: '私の父は背が高いです。' }
      },
      {
        picture: '👦',
        ...
        exampleSentences: { en: 'He has one brother.', es: 'Tiene un hermano.', fr: 'Il a un frère.', de: 'Er hat einen Bruder.', it: 'Lui ha un fratello.', ar: 'لديه أخ واحد.', ko: '그는 남자 형제가 한 명 있습니다.', ja: '彼には兄弟が一人のみいます。' }
      },
      {
        picture: '👧',
      ...
      {
        picture: '👴',
        translations: { en: 'Grandfather', es: 'Abuelo', fr: 'Grand-père', de: 'Großvater', it: 'Nonno', ar: 'جد', ko: '할아버지', ja: '祖父' },
  ...
  // 6. Numbers
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentences: { en: 'I see five birds.', es: 'Veo cinco pájaros.', fr: 'Je vois cinq oiseaux.', de: 'Ich sehe fünf Vögel.', it: 'Vedo cinque uccelli.', ar: 'أنا أرى خمسة طيور.', ko: '저는 새 다섯 마리를 봅니다.', ja: '私は鳥を五羽見ています。' }
      },
      {
        picture: '6️⃣',
  ...
  // 7. Colors
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentences: { en: 'The sun is yellow.', es: 'El sol es amarillo.', fr: 'Le soleil est jaune.', de: 'Die Sonne ist gelb.', it: 'Il sol è giallo.', ar: 'الشمس صفراء.', ko: '태양은 노란색입니다.', ja: '太陽は黄色いです。' }
      },
      {
        picture: '⚫',
  ...
  // 8. Clothing
  {
    ...
    words: [
      ...
      {
        picture: '👖',
        translations: { en: 'Pants', es: 'Pantalones', fr: 'Pantalon', de: 'Hose', it: 'Pantaloni', ar: 'بنطال', ko: '바지', ja: 'ズボン' },
  ...
  // 10. Weather
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentences: { en: 'The tea is hot.', es: 'El té está caliente.', fr: 'Le thé est chaud.', de: 'Der Tee ist heiß.', it: 'Il tè è caldo.', ar: 'الشاي ساخن.', ko: '차가 뜨겁습니다.', ja: 'お茶が熱いです。' }
      },
      {
        picture: '❄️',
  ...
  // 11. Airport
  {
    ...
    words: [
      ...
      },
      {
        ...
        pronunciations: { en: 'Passport', es: 'pah-sah-por-teh', fr: 'pahs-pohr', de: 'rye-ze-pas', it: 'pahs-sah-por-toh', ar: 'ja-waz sa-far', ko: 'yeo-gwon', ja: 'pasu-pooto' },
      ...
      {
        picture: '🧳',
        translations: { en: 'Luggage', es: 'Equipaje', fr: 'Bagage', de: 'Gepäck', it: 'Bagaglio', ar: 'أمتعة', ko: '수하물', ja: '荷물' },
        pronunciations: { en: 'Luggage', es: 'eh-kee-pah-heh', fr: 'bah-gahzh', de: 'guh-pek', it: 'bah-gah-lyoh', ar: 'am-ti-ah', ko: 'su-ha-mool', ja: 'nimotsu' },
        exampleSentences: { en: 'This is my luggage.', es: 'Este es mi equipaje.', fr: 'C\'est mon bagage.', de: 'Das ist mein Gepäck.', it: 'Questo è il mio bagaglio.', ar: 'هذه أمتعتي.', ko: '이것은 제 수하물입니다.', ja: 'これは私の荷物です。' }
      },
      {
        picture: '🚪',
  ...
  // 14. Restaurant
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentences: { en: 'Call the waiter.', es: 'Llama al camarero.', fr: 'Appelez le serveur.', de: 'Rufe den Kellner.', it: 'Chiama il cameriere.', ar: 'نادِ النادل.', ko: '웨이터를 불러주세요.', ja: 'ウェイターを呼んでください。' }
      }
    ]
  },
  // 15. Shopping
  ...
  // 16. School
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentences: { en: 'I am a student.', es: 'Soy estudiante.', fr: 'Je suis étudiant.', de: 'Ich bin Schüler.', it: 'Sono uno studente.', ar: 'أنا طالب.', ko: '저는 학생입니다.', ja: '私は学生です。' }
      },
      {
        picture: '📖',
    ...
    words: [
      {
        ...
        exampleSentences: { en: 'Where is the hospital?', es: '¿Dónde está el hospital?', fr: 'Où est l\'hôpital?', de: 'Wo ist das Krankenhaus?', it: 'Dov\'è l\'ospedale?', ar: 'أين المستشفى؟', ko: '병원익 어디에 있나요?', ja: '病院はどこにありますか？' }
      },
      {
        picture: '🥼',
        translations: { en: 'Doctor', es: 'Médico', fr: 'Médecin', de: 'Arzt', it: 'Medico', ar: 'طبيب', ko: '의사', ja: '医師' },
        pronunciations: { en: 'Doctor', es: 'meh-dee-coh', fr: 'med-sanh', de: 'artst', it: 'meh-dee-coh', ar: 'ta-beeb', ko: 'ui-sa', ja: 'ishi' },
      ...
      {
        picture: '💊',
        translations: { en: 'Medicine', es: 'Medicina', fr: 'Médicament', de: 'Medizin', it: 'Medicina', ar: 'دواء', ko: '약', ja: '薬' },
      ...
      },
      {
        ...
        pronunciations: { en: 'Hurt', es: 'doh-lair', fr: 'bles-say', de: 'vey-toon', it: 'mah-leh', ar: 'a-lam', ko: 'da-chi-da', ja: 'itai' },
...
languages.forEach(lang => {
  ...
  curriculumData.forEach((ld, index) => {
    // Generate mapped words
    const words = ld.words.map(w => {
      // Meaning is English unless learning English, in which case it is Spanish
      ...
      return {
        ...
        audioUrl: '' // TTS plays it dynamically
      };
    });

    const questions = [];

    // Ensure we have enough words to build questions (should have 6)
    if (words.length >= 6) {
      ...
      // Q3: Image Recognition (Identify Image)
      questions.push({
        type: 'identify-image',
      ...
      // Q7: Fill-in-the-blank (writing practice)
      ...
      // Q8: Translation / Writing Practice
    ...
    lessonsData.push({
      ...
      xpReward: ld.unit === 1 ? 20 : 30, // scaled reward
      words: words,
      questions: questions
    });
  });

  // 19. Boss Challenge (compiled quiz across the whole syllabus)
  const bossLesson = {
    ...
    unitTitle: 'Real-Life Scenarios',
    xpReward: 50,
    words: [], // No flashcards for the boss challenge
    questions: [
      {
        type: 'multiple-choice',
        prompt: `How do you say "Thank you" in ${lang}?`,
        options: [
          curriculumData[0].words[2].translations[langKey], // Thank you
          curriculumData[0].words[0].translations[langKey], // Hello
          curriculumData[0].words[1].translations[langKey], // Goodbye
          curriculumData[0].words[3].translations[langKey]  // Please
      ...
      },
      {
        ...
        audioText: curriculumData[2].words[1].translations[langKey], // Cat
        imageOptions: ['🐱', '🐶', '🐐', '🐦'].sort(() => Math.random() - 0.5),
        correctAnswer: '🐱'
      },
      {
...
fs.writeFileSync(path.join(process.cwd(), 'server', 'src', 'data', 'lessonsData.js'), fileContent);
console.log('Successfully generated new lessonsData.js');
